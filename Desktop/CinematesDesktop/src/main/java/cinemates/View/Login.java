...
import cinemates.Controller.ControllaLoginController;
...
public class Login extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ControllaLoginController controllaLoginController = new ControllaLoginController();
        Boolean presente = controllaLoginController.onButtonLoginClicked(jTextField1.getText().toString(),jPasswordField1.getText().toString());
